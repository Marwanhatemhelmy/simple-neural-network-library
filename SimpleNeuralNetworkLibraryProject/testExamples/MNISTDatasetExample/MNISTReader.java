...
public class MNISTReader {
    ...
    public MNISTReader(int numberOfImages){
        try{
            String trainImagesPath = "testExamples/MNISTDatasetExample/data/train-images-idx3-ubyte";
            String trainLabelsPath = "testExamples/MNISTDatasetExample/data/train-labels-idx1-ubyte";
